            ...
            var options = {
                ...
                series: [{
                    ...
                    data: [data.pActual[0].VentaTotalActual, data.pActual[1].VentaTotalActual, data.pActual[2].VentaTotalActual,
                        data.pActual[3].VentaTotalActual, data.pActual[4].VentaTotalActual, data.pActual[5].VentaTotalActual,
                        data.pActual[6].VentaTotalActual, data.pActual[7].VentaTotalActual]
                }, {
                    name: 'Periodo - 2019',
